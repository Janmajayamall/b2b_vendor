...
import { REGISTER_BUYER } from "../../graphql/apolloQueries/index"
...
class CreateBuyerAccount extends React.PureComponent {
    constructor(props) {
        super(props)
    ...
    createBuyerAccount = async (values) => {
        ...
        try {
            ...
            const registerBuyer = data.registerBuyer

            //checking for error
            if (registerBuyer.error !== constants.errorCodes.noError) {
                //check for error: email already exists
                if (registerBuyer.error === constants.errorCodes.emailExists) {
                    this.setState({
                        error: {
                            error: true,
                            text: "Error Email ID",
            ...
            console.log(`create buyer account error: ${e}`)
            this.setState({
                error: {
                    error: true,
                    text: "ERROR",
        ...
        return (
            <div className="initial-page">
                ...
                >
                    ...
                    <Form layout="vertical" onFinish={this.createBuyerAccount}>
                        <Form.Item
...
export default withRouter(withApollo(CreateBuyerAccount))
